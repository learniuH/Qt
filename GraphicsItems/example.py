...
class ControlButton(QtWidgets.QWidget):
    ...
    def __initButton(self):
        ...
        self.right.setPolygon(QtGui.QPolygonF([QtCore.QPoint(int(x), int(-y)), QtCore.QPoint(int(x), int(y)), QtCore.QPoint(int(x_), 0)]))
        ...
        self.down.setPolygon(QtGui.QPolygonF([QtCore.QPoint(int(x), int(-y)), QtCore.QPoint(int(x), int(y)), QtCore.QPoint(int(x_), 0)]))
        ...
        self.left.setPolygon(QtGui.QPolygonF([QtCore.QPoint(int(x), int(-y)), QtCore.QPoint(int(x), int(y)), QtCore.QPoint(int(x_), 0)]))
        ...
        self.up.setPolygon(QtGui.QPolygonF([QtCore.QPoint(int(x), int(-y)), QtCore.QPoint(int(x), int(y)), QtCore.QPoint(int(x_), 0)]))
